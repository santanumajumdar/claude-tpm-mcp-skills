...
```json
{
  "mcpServers": {
    "sprint-retro-summarizer": {
      "command": "/path/to/repo/skills/sprint-retro-summarizer/venv/bin/python",
      "args": [
        "/path/to/repo/skills/sprint-retro-summarizer/server.py"
      ],
      "env": {
...
> "Claude, summarize the feedback in the retro channel and draft action items."
