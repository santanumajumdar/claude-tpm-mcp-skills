...
```json
{
  "mcpServers": {
    "chaos-engineering-planner": {
      "command": "/path/to/repo/skills/chaos-engineering-planner/venv/bin/python",
      "args": [
        "/path/to/repo/skills/chaos-engineering-planner/server.py"
      ],
      "env": {
...
> "Claude, look at our recent RDS outages and propose a chaos experiment to validate our failover mechanism."
