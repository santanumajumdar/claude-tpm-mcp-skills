...
```json
{
  "mcpServers": {
    "release-notes-intelligence": {
      "command": "/path/to/repo/skills/release-notes-intelligence/venv/bin/python",
      "args": [
        "/path/to/repo/skills/release-notes-intelligence/server.py"
      ],
      "env": {
...
**Example Command:**
> "Claude, generate release notes for version v2.4.0, separating technical notes from business highlights."
