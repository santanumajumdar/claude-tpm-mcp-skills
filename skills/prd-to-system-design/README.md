...
```json
{
  "mcpServers": {
    "prd-to-system-design": {
      "command": "/path/to/repo/skills/prd-to-system-design/venv/bin/python",
      "args": [
        "/path/to/repo/skills/prd-to-system-design/server.py"
      ],
      "env": {
...
**Example Command:**
> "Claude, read the PRD for the new Notification Service and generate the C4 architecture diagram."
