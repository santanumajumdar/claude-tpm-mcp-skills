...
```json
{
  "mcpServers": {
    "feature-flag-manager": {
      "command": "/path/to/repo/skills/feature-flag-manager/venv/bin/python",
      "args": [
        "/path/to/repo/skills/feature-flag-manager/server.py"
      ],
      "env": {
...
> "Claude, find all feature flags older than 6 months that are at 100% rollout."
