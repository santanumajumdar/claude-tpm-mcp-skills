...
```json
{
  "mcpServers": {
    "slo-violation-detector": {
      "command": "/path/to/repo/skills/slo-violation-detector/venv/bin/python",
      "args": [
        "/path/to/repo/skills/slo-violation-detector/server.py"
      ],
      "env": {
...
> "Claude, check the error budget burn rate for the Checkout service."
