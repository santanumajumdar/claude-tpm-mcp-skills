...
```json
{
  "mcpServers": {
    "compliance-audit-generator": {
      "command": "/path/to/repo/skills/compliance-audit-generator/venv/bin/python",
      "args": [
        "/path/to/repo/skills/compliance-audit-generator/server.py"
      ],
      "env": {
...
> "Claude, generate the Q3 SOC2 compliance audit report focusing on access control."
