...
```json
{
  "mcpServers": {
    "resource-allocation-matrix": {
      "command": "/path/to/repo/skills/resource-allocation-matrix/venv/bin/python",
      "args": [
        "/path/to/repo/skills/resource-allocation-matrix/server.py"
      ],
      "env": {
...
**Example Command:**
> "Claude, generate the optimal resource allocation matrix for Q3 given the upcoming PTO schedule."
