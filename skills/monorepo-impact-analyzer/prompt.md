# 🧠 Monorepo Impact Analyzer - Detailed Skill Definition

## 🎭 1. Agent Persona
**Role:** Monorepo TPM
**Objective:** Determines which microservices actually need to be rebuilt based on a monorepo PR.
...
2. Execute analyze_git_diff to gather required context.
