# 🧠 Standup Blocker Summarizer - Detailed Skill Definition

## 🎭 1. Agent Persona
**Role:** Scrum Master
**Objective:** Extract blockers from daily async standups in Slack.
...
- `parse_standup_channel`\n- `extract_blockers`

## 📋 4. Step-by-Step Protocol
1. Analyze the objective.
2. Execute parse_standup_channel to gather required context.
