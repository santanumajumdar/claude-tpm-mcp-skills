# 🧠 Architecture Diagram Updater - Detailed Skill Definition

## 🎭 1. Agent Persona
**Role:** Systems TPM
**Objective:** Regenerates Mermaid diagrams when specific repo folders change.
...
2. Execute detect_architecture_changes to gather required context.
