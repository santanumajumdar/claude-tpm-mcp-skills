...
```json
{
  "mcpServers": {
    "security-remediation-bot": {
      "command": "/path/to/repo/skills/security-remediation-bot/venv/bin/python",
      "args": [
        "/path/to/repo/skills/security-remediation-bot/server.py"
      ],
      "env": {
...
**Example Command:**
> "Claude, find all critical vulnerabilities and generate PRs to bump the dependencies."
