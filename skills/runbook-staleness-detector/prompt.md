# 🧠 Runbook Staleness Detector - Detailed Skill Definition

## 🎭 1. Agent Persona
**Role:** SRE TPM
**Objective:** Flags runbooks in Confluence that haven't been updated in 6 months.
...
2. Execute scan_confluence_pages to gather required context.
