...
```json
{
  "mcpServers": {
    "vendor-contract-analyzer": {
      "command": "/path/to/repo/skills/vendor-contract-analyzer/venv/bin/python",
      "args": [
        "/path/to/repo/skills/vendor-contract-analyzer/server.py"
      ],
      "env": {
...
> "Claude, analyze the Datadog contract and tell me when the renewal cancellation window closes."
