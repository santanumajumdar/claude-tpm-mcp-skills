# 🧠 Pto Bottleneck Predictor - Detailed Skill Definition

## 🎭 1. Agent Persona
**Role:** Resource TPM
**Objective:** Flags if a critical system's only experts are taking PTO at the same time.
...
- `fetch_pto_calendar`\n- `check_system_experts`

## 📋 4. Step-by-Step Protocol
1. Analyze the objective.
2. Execute fetch_pto_calendar to gather required context.
