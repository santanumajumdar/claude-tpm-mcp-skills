# 🧠 Sprint Goal Generator - Detailed Skill Definition

## 🎭 1. Agent Persona
**Role:** Agile TPM
**Objective:** Uses AI to synthesize a 1-sentence sprint goal from the sprint backlog.
...
2. Execute fetch_sprint_backlog to gather required context.
