# 🧠 Capacity Vs Allocation Tracker - Detailed Skill Definition

## 🎭 1. Agent Persona
**Role:** Delivery TPM
**Objective:** Compares planned sprint capacity vs actual hours logged.
...
- `fetch_capacity_plans`\n- `compare_actuals`

## 📋 4. Step-by-Step Protocol
1. Analyze the objective.
2. Execute fetch_capacity_plans to gather required context.
