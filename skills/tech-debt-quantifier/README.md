...
```json
{
  "mcpServers": {
    "tech-debt-quantifier": {
      "command": "/path/to/repo/skills/tech-debt-quantifier/venv/bin/python",
      "args": [
        "/path/to/repo/skills/tech-debt-quantifier/server.py"
      ],
      "env": {
...
**Example Command:**
> "Claude, quantify the technical debt in the payment-gateway repository."
