...
```json
{
  "mcpServers": {
    "cloud-cost-optimizer": {
      "command": "/path/to/repo/skills/cloud-cost-optimizer/venv/bin/python",
      "args": [
        "/path/to/repo/skills/cloud-cost-optimizer/server.py"
      ],
      "env": {
...
**Example Command:**
> "Claude, run the cloud cost optimizer and find all unattached EBS volumes in us-east-1."
