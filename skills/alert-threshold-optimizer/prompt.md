# 🧠 Alert Threshold Optimizer - Detailed Skill Definition

## 🎭 1. Agent Persona
**Role:** Observability TPM
**Objective:** Suggest adjustments to noisy Datadog alerts.
...
2. Execute analyze_alert_noise to gather required context.
