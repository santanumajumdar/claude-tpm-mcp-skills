...
{
  "mcpServers": {
    "on-call-scheduler-bot": {
      "command": "/path/to/repo/skills/on-call-scheduler-bot/venv/bin/python",
      "args": [
        "/path/to/repo/skills/on-call-scheduler-bot/server.py"
      ],
      "env": {
...
> "Claude, check the alert fatigue for the Core Platform team and suggest next month's rotation."
